...
<input id="znid2" type="hidden" name="znid">
<input id="prid" type="hidden" name="prid" value="<?php echo $predlozak->prid?>">
<tr colspan="2">
    <td>Platitelj</td>
</tr>
<tr>
...
<tr>
    ...
    <td>HR <select name="model_odobrenja_id" class="input-mini" required>
            ...
            <?php } ?>
        </select><input type="text" name="broj_odobrenja" class="pozivNaBroj" maxlength="22" required value="<?php echo $predlozak->broj_odobrenja?>">
    </td>
</tr> <tr>
        <td>Primatelj</td>
    </tr>
    ...
    <tr>
        ...
        <td>HR <select name="model_zaduzenja_id" class="input-mini" required>
                <?php foreach ($modeli as $model) {
                    ...
                    <option value=<?php echo $model->id; ?>><?php echo $model->naziv ?></option>
                <?php } ?>
            </select><input type="text" name="broj_zaduzenja" class="pozivNaBroj" maxlength="22" required  value="<?php echo $predlozak->broj_zaduzenja?>">
        </td>
    </tr>
    <tr colspan="2">
        <td>Plaćanje</td>
