...
<tr>
    ...
    <td>HR <select name="model_odobrenja_id" class="input-mini" required>
            ...
            <?php } ?>
        </select><input type="text" name="broj_odobrenja" class="pozivNaBroj" required">
    </td>
</tr><label>
    <tr class="active">
        <td>Primatelj</td>
    ...
    <tr>
        ...
        <td><input type="text" name="iban_prefix" id="iban_prefix" value="HR" class="input-micro">
            <input type="text"name="iban"id="iban" pattern=".{19,19}"maxlength="19"required class="input-medium">&nbsp;<span id="errmsg"></span></td>
    </tr>
    ...
    <tr>
        ...
        <td>HR <select name="model_zaduzenja_id" class="input-mini" required>
                <?php foreach ($modeli as $model) {
                    ...
                    <option value=<?php echo $model->id; ?>><?php echo $model->naziv ?></option>
                <?php } ?>
            </select><input type="text" name="broj_zaduzenja" class="pozivNaBroj" required">
        </td>
    </tr>
    <tr colspan="2">
        <td>Plaćanje</td>
